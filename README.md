...
`virtualNicheR` is an `R` package that generates virtual [fundamental
and realised niches](https://en.wikipedia.org/wiki/Ecological_niche)
that can be used as the basis for virtual ecology experiments examining
questions around ecological niche modelling. The fundamental niches are
