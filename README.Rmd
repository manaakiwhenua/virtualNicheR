...
`virtualNicheR` is an `R` package that generates virtual [fundamental and realised niches](https://en.wikipedia.org/wiki/Ecological_niche)
that can be used as the basis for virtual ecology experiments examining questions around ecological niche modelling.  The fundamental niches
are defined as [multivariate normal distributions](https://en.wikipedia.org/wiki/Multivariate_normal_distribution), 
and the realised niches are created by defining the positive and negative interactions amongst a community of fundamental niches.  A full 
description of the `virtualNicheR` package, including connections to niche theory and an explanation of the underlying mathematics, can be 
found in the associated [software paper](link).

## Citation

If you use `virtualNicheR` in your research we would be very grateful if you could please cite the software using:

[Etherington TR, Omondiagbe, OP (2019) virtualNicheR: creating virtual fundamental and realised niches, Journal of Open Source Software](link)
